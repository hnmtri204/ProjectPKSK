...
import HomepageBanner1 from '../assets/banner-spe.png';
import HomepageBanner3 from '../assets/banner5.png';
...
const Header1 = () => {
    ...
    return (
        <div className='rounded-lg px-6 md:px-10 lg:px-20'>
            <Slider {...settings}>
                <div className='relative' style={{ height: "400px" }}>
                    <img
                        src={HomepageBanner}
                        alt="Homepage Banner"
                        className='absolute inset-0 w-full h-full object-cover z-0 rounded-lg' // Thêm border-radius
                    />
                    <div className='flex flex-col md:flex-row flex-wrap relative z-10'>
                        ...
                        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:py-[10vw] ml-8'>
                            ...
                            <div className='flex flex-col md:flex-row items-start gap-3 text-[#00759c]'>
                                <img className='w-28 rounded-lg' src={assets.group_profiles} alt="" /> {/* Thêm border-radius */}
                                <p>
                ...
                <div className='relative' style={{ height: "400px" }}>
                    ...
                    <div className='flex flex-col md:flex-row flex-wrap relative z-10'>
                        ...
                        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:py-[10vw] ml-8'>
                            <p className='text-3xl md:text-4xl lg:text-5xl text-[#00759c]'>
                                Đội ngũ bác sĩ chuyên nghiệp <br /> luôn sẵn sàng hỗ trợ bạn
                            </p>
                            <div className='flex flex-col md:flex-row items-start gap-3 text-[#00759c]'>
                                <img className='w-28 rounded-lg' src={assets.group_profiles} alt="" /> {/* Thêm border-radius */}
                                <p>
                                    Chúng tôi cung cấp dịch vụ chăm sóc sức khỏe toàn diện <br className='hidden sm:block' /> với đội ngũ bác sĩ chuyên môn cao.
                                </p>
                            </div>
                            <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-[#00759c] text-sm hover:scale-105 transition-all duration-300'>
                ...
                <div className='relative' style={{ height: "400px" }}>
                    <img
                        src={HomepageBanner4} // Giả sử bạn đã thêm ảnh cho banner 4
                    ...
                    <div className='flex flex-col md:flex-row flex-wrap relative z-10'>
                        ...
                        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:py-[10vw] ml-8'>
                            ...
                            <a href="#services" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-[#00759c] text-sm hover:scale-105 transition-all duration-300'>
                                Tìm hiểu thêm về công nghệ <img className='w-3' src={assets.arrow_icon} alt="" />
                            </a>
                        </div>
                    </div>
                </div>
