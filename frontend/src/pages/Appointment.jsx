          ...
          <div className="flex gap-3 items-center w-full overflow-x-scroll mt-4">
            {Object.keys(doctorSchedule).map((dateStr) => {
              ...
              return (
                <div
                  key={dateStr}
                  className={`text-center py-6 min-w-16 rounded-full border cursor-pointer ${selectedDate === dateStr
                ...
                >
                  <p
                    className={`text-gray-600 ${selectedDate === dateStr ? "text-white" : "text-gray-600"
                      }`}
                  >
                    {dayOfWeek}
                  </p>
            ...
            {selectedDate &&
              doctorSchedule[selectedDate].map((schedule) => (
                <p
                  ...
                  className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${slotTime ===
                      (schedule.work_shift === "morning"
                        ? "Buổi sáng"
                        : "Buổi chiều")
                      ? "bg-[#00759c] text-white"
